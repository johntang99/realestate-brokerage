...
export default function SellingPage() {
  ...
  const MARKETING = [
    ...
    { title: 'Social Media Campaigns', desc: 'Targeted social ads reaching qualified buyers in Westchester and the NYC metro area.' },
    ...
    <>
      <section className="relative pt-20" style={{ minHeight: '52vh', background: 'var(--primary)' }}>
        <div className="container-custom pt-16 pb-16">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] mb-3" style={{ color: 'var(--secondary)' }}>Selling</p>
          ...
          <div className="flex gap-6 mb-7">
            {[{ v: '103%', l: 'Avg Sale-to-List' }, { v: '24 days', l: 'Avg DOM' }, { v: '620+', l: 'Homes Sold' }].map((s, i) => (
              <div key={i}>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href={`/${locale}/home-valuation`} className="btn-gold px-7 py-3">Get My Home's Value</Link>
        ...
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="text-sm mt-3 max-w-xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
              Most agents list your home on the MLS and wait. We run a full marketing campaign — here's exactly what that means.
            </p>
          </div>
      ...
      <section className="section-padding" style={{ background: 'var(--backdrop-light)' }}>
        <div className="container-custom max-w-2xl">
          <div className="text-center mb-8">
            ...
            <h2 className="font-serif text-3xl font-semibold" style={{ fontFamily: 'var(--font-heading)', color: 'var(--primary)' }}>What Is Your Home Worth?</h2>
            <p className="text-sm mt-2" style={{ color: 'var(--text-secondary)' }}>A local agent will prepare your personalized valuation report within 24 hours.</p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5 text-center">
            {['Consultation', 'Pricing Strategy', 'Home Prep', 'List & Market', 'Offers & Negotiate', 'Close'].map((step, i) => (
              <div key={i}>
      ...
      <section className="py-16" style={{ background: 'var(--primary)' }}>
        <div className="container-custom text-center">
          <h2 className="font-serif text-3xl font-semibold text-white mb-4" style={{ fontFamily: 'var(--font-heading)' }}>Ready to Sell?</h2>
          <p className="text-white/70 mb-7 max-w-md mx-auto">Schedule a free listing consultation — no obligation, just expert advice.</p>
          <Link href={`/${locale}/contact`} className="btn-gold inline-block px-8 py-3.5">Schedule a Listing Consultation</Link>
        </div>
      </section>
    </>
  );
